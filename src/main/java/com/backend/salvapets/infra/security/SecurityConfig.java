package com.backend.salvapets.infra.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                                ...
                                .requestMatchers(HttpMethod.GET, "/denuncias").permitAll()
                                .requestMatchers(HttpMethod.POST, "/denuncias").permitAll()
//                        .requestMatchers(HttpMethod.GET, "/pets/usuario/{id}").permitAll()
